...
import cap from "../Image/icondog.png"
import AOS from "aos"
        ...
        <Box >
            <Box data-aos="fade-left" position='relative' top='-100px' borderRadius={'10px'} left={'20%'} backgroundColor='#eef4fae6' width={'60%'} boxShadow='rgba(0, 0, 0, 0.35) 0px 5px 15px'>
                <Box style={{ display: 'flex', flexDirection: 'row', alignItems: 'center' }}>
                    ...
                    <a style={{ marginTop: '23px' }} href="https://git.io/typing-svg"><img src="https://readme-typing-svg.demolab.com?font=Fira+Code&weight=700&size=23&pause=1000&color=212121&repeat=false&width=445&lines=Login+to+Dogline." alt="Typing SVG" /></a>
                </Box>
                <Box  width={'80%'} m='auto'>
                    <Flex
                            ...
                            <Box
                                ...
                                <Stack data-aos="fade-left" spacing={9}>
                                    ...
                                    <Flex width={'100%'}  direction={'column'} justifyContent={'space-between'} >
                                        ...
                                        <Box width={{base:'100%',md:'100%'}} pt={'20px'}  margin={'auto'}>
